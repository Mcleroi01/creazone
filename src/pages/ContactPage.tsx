...
export const ContactPage = () => {
  const pageTitle = "Contact - CréaZone";
  const pageDescription = "Contactez l'équipe de CréaZone pour toute question, suggestion ou demande de partenariat. Nous sommes là pour vous aider !";
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
      <SEO
        ...
        meta={[
          ...
          // Autres balises
          { name: 'keywords', content: 'contact, support, assistance, questions, suggestions, créazone' }
        ]}
      />
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <input
                  ...
                  className={`block w-full px-4 py-3 rounded-md border ${errors.name && touched.name
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <input
                  ...
                  className={`block w-full px-4 py-3 rounded-md border ${errors.email && touched.email
                      ? 'border-red-300 dark:border-red-700 focus:ring-red-500 focus:border-red-500'
                      : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white'
                    }`}
            ...
            <div>
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                <textarea
                  ...
                  className={`block w-full px-4 py-3 rounded-md border ${errors.message && touched.message
                      ? 'border-red-300 dark:border-red-700 focus:ring-red-500 focus:border-red-500'
                      : 'border-gray-300 dark:border-gray-600 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white'
                    }`}
